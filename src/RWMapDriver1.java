public class RWMapDriver1 {
	private static final int NUMOPS = 10;
	private static final int NUMTICKS = 10;
	private static final int NUM_TRAJECTS = 5;
	private static ReadWriteStatusMap sm = new ReadWriteStatusMap();

	public static void main(String args[]) {
		RWMapDriver1 driver = new RWMapDriver1();
	...
	public ReadWriteStatusMap getStatusMap() {
		return sm;
	}
	
	private static void doSomething(RWMapDriver1 driver, ReadWriteStatusMap sm) {
	...
	private static class Doer extends Thread {
		    private static RWMapDriver1 driver;
		    private static ReadWriteStatusMap sm;

		    Doer(RWMapDriver1 inDriver) {
		      driver = inDriver;
